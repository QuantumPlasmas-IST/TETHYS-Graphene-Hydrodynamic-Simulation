...
int main(int argc, char **argv){
    ...
    Radiation Rad(3.,6.,0.5,0.5,3000);
    ...
    //array with 2 emitter
    vector<double> O_x2{0,1.};
    vector<double> O_y2{0,1.};
    ...
    //
    Rad.Set_n_index(1.0);
    Rad.Set_epsilon_r(1.0);
    Rad.SetD_Conductor(0.0);
    ...
    //
    Rad.Set_n_index(2.5);
    Rad.Set_epsilon_r(6.25);
    Rad.SetD_Conductor(0.75);
    Rad.SetR_Conductor(0.75);
