...
#include "../Library_Rui/Spline3Interpolator.h"
...
class Radiation{
public:
	Radiation(double vFermi=10.5, double n_index_ref=2.5, double Dist_Conductor=1.5, double R_Conductor=2, double Dist_dieletric=0.05, double Distance_measure=3000);
	...
	void RadiationPatternTimeAverage180(double t0, vector<double> O_x_v, vector<double> O_y_v, int N, int N_t_points, double delta_t, bool print);
	double RadiationPatternTimeAverage360(double t0, vector<double> O_x_v, vector<double> O_y_v, int N, int N_t_points, double delta_t, bool print);
