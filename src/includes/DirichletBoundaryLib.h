...
class  DirichletBoundaryCondition : public BoundaryCondition
{
	...
	static void JetRight(Fluid2D& fluid_class,float right, float right_width);   ///< Jet configuration i.e. fixed flux x component at a portion of given with around the center of the edge x=L. Useful to study turbulence onset
	static void JetLeft(Fluid2D& fluid_class, float left, float left_width);   ///< Jet configuration i.e. fixed flux x component at a portion of given with around the center of the edge x=0. Useful to study turbulence onset
