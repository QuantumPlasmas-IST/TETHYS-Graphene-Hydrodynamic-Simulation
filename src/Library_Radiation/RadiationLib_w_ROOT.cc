...
void Radiation::PrintGraphElectro(int Nl_0, int Nl){
    ...
    gr_DipX->SetTitle(";Time;Eletric Dipole X");
    gr_DipY->SetTitle(";Time;Eletric Dipole Y");
    gr_DipX_dd->SetTitle(";Time;d^{2}(Eletric Dipole X)/dt^{2}");
    gr_DipY_dd->SetTitle(";Time;d^{2}(Eletric Dipole Y)/dt^{2}");
    gr_QuadXX->SetTitle(";Time;Eletric Quadrupole XX");
    gr_QuadXY->SetTitle(";Time;Eletric Quadrupole XY");
    gr_QuadYY->SetTitle(";Time;Eletric Quadrupole YY");
    gr_QuadXX_ddd->SetTitle(";Time;d^{3}(Eletric Quadrupole XX)/dt^{3}");
    gr_QuadXY_ddd->SetTitle(";Time;d^{3}(Eletric Quadrupole XY)/dt^{3}");
    gr_QuadYY_ddd->SetTitle(";Time;d^{3}(Eletric Quadrupole YY)/dt^{3}");
    gr_DipMagZ->SetTitle(";Time;Magnetic Dipole Z");
    gr_DipMagZ_dd->SetTitle(";Time;d^{2}(Magnetic Dipole Z)/dt^{2}");
...
void Radiation::PrintGraphInterpolation(int Nl_0, int Nl){
    ...
    grI_DipX_dd->SetTitle(";Time;d^{2}(Eletric Dipole X)/dt^{2}");
    grI_DipY_dd->SetTitle(";Time;d^{2}(Eletric Dipole Y)/dt^{2}");
    grI_QuadXX_ddd->SetTitle(";Time;d^{3}(Eletric Quadrupole XX)/dt^{3}");
    grI_QuadXY_ddd->SetTitle(";Time;d^{3}(Eletric Quadrupole XY)/dt^{3}");
    grI_QuadYY_ddd->SetTitle(";Time;d^{3}(Eletric Quadrupole YY)/dt^{3}");
    grI_DipMagZ_dd->SetTitle(";Time;d^{2}(Magnetic Dipole Z)/dt^{2}");
