...
Vec Radiation::E_field(double t, double x, double y, double z){
    ...
    E_field_v = (1/(4*M_PI*r))*E_Dip + (1/(24*M_PI*300*vF*r))*E_Quad + (1/(4*M_PI*r2*300*vF))*E_DipMag;
...
Vec Radiation::H_field(double t, double x, double y, double z){
    ...
    H_field_v = (-1/(4*M_PI*r2))*r_vec.ex(p_dd) + (-1/(24*M_PI*300*vF*r2))*r_vec.ex(Q_ddd) + (1/(4*M_PI*r*300*vF))*H_DipMag;
