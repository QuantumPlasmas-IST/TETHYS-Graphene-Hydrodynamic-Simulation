...
int main(int argc, char **argv){
	...
	BerryFluid graph(parameters);

	/*......CFL routine to determine dt...............................*/
	graph.CflCondition();
	//graph.SetDt(graph.GetDt()*0.25f);
	dt=0.5*graph.GetDt();
	graph.SetDt(0.5*graph.GetDt());
	/*................................................................*/
	...
	InitialCondition::InitialCondGeneral(graph,
										 [](float x,float y) { return 1.0f + 0.5f*x; },
	...
	DirichletBoundaryCondition::Jet(graph, 0.5f, 0.4f, 0.0f, 0.0f);
	//DirichletBoundaryCondition::JetLeft(graph, 1.0f, 0.2f);
