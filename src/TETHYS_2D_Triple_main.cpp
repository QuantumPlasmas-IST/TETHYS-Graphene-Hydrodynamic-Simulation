...
int main(int argc, char **argv){
    ...
    TripleGraphene2D graph(parameters);
    ...
    /*.Determined maximum simulated time
.....CFL routine to determine dt...............................*/
    ...
    TripleGraphene2D::BannerDisplay();
    graph.WelcomeScreen();
...
//	graph.InitialCondUniform();
    ...
    while (t <= graph.GetTmax() ){
        int percentage=100*TripleGraphene2D::TimeStepCounter/(graph.GetTmax()/dt);
        cout << percentage<<"%\033[?25l"; //prints the percentage of simulation completed

        t += dt;
        TripleGraphene2D::TimeStepCounter++;
        ...
        //BoundaryCondition::XFreeLeft(graph);
        //BoundaryCondition::XFreeRight(graph);
        //BoundaryCondition::YFreeTop(graph);
        //BoundaryCondition::YFreeBottom(graph);
        ...
        if( !( TripleGraphene2D::TimeStepCounter % 2) ){
